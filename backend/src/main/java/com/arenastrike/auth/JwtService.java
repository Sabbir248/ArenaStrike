...
public class JwtService {
    // In production, load this from external configuration
    private static final String SECRET_KEY = "ArenaStrikeSuperSecretKeyForJwtGenerationArenaStrikeSuperSecretKeyForJwtGeneration";
